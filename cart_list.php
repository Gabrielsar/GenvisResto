        	...
        	<div class="col-lg-8">
        		<div class="sticky">
	        		<div class="card">
	        			<div class="card-body">
	        				<div class="row">
		        				<div class="col-md-8"><b>Menu</b></div>
	        		...
	        		<div class="card-body">
		        		<div class="row">
			        		...
			        		<div class="col-md-4 text-right">
			        			<b><large><?php echo "Rp".number_format($row['qty'] * $row['price'],2) ?></large></b>
			        		</div>
		        		</div>
	        		</div>
	        	</div>
        		...
        		<div class="sticky">
        			<div class="card">
        				<div class="card-body">
        					...
        					<hr>
        					<p class="text-right"><b><?php echo "Rp".number_format($total,2) ?></b></p>
        					<hr>
        				</div>
        			</div>
        		</div>
